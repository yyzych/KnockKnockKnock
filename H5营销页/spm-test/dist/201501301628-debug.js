...
* 具体项目的页面js
*/
define("ych/h5ads/1.0.0/201501301628-debug", [ "./app-debug", "./modules\\zepto\\zepto-debug", "./modules\\appAudio-debug", "./modules\\appVideo-debug", "./modules\\addHorizontalSlide-debug" ], function(require, exports, module) {
    var app = require("./app-debug"), appVideo = require("./modules/appVideo-debug"), //之前已经有一次加载过了，已经在系统中了。虽然这里也依赖，但不会又重新执行依赖模块里面的代码??!
    addHorizontalSlide = require("./modules/addHorizontalSlide-debug");
    var pages = $(".page");
    (function() {
...
define("ych/h5ads/1.0.0/app-debug", [ "ych/h5ads/1.0.0/modules/zepto/zepto-debug", "ych/h5ads/1.0.0/modules/appAudio-debug" ], function(require, exports, module) {
    // 加载依赖模块
    var $ = require("ych/h5ads/1.0.0/modules/zepto/zepto-debug"), appAudio = require("ych/h5ads/1.0.0/modules/appAudio-debug");
    ...
    App.prototype.slideHandler = function(e) {
        var that = this;
        var currentPage = null, activePage = null, startX = 0, startY = 0, moveDistX = 0, moveDistY = 0, loop = !1, isStart = !1, //移动是否开始。touchstart时设为true
        isPrev = !1, //activePage是否是currentpage的前一个兄弟元素
        isFirstTimeTouch = !1;
        //表示第一次按下鼠标。touchstart时设为true，touchmove时设为false
        ...
        that.$app.on("touchstart", function(e) {
            ...
            if (isStart && (activePage || isFirstTimeTouch) && (moveDistY = e.touches[0].pageY - startY, 
            moveDistX = e.touches[0].pageX - startX, Math.abs(moveDistY) > Math.abs(moveDistX))) {
                if (moveDistY > 0) {
                    ...
                    if (!isPrev || isFirstTimeTouch) {
                        ...
                        if (activePage && activePage.classList.contains("page")) {
                            //因为上面一步有可能取到：loop?that.$pages.last().get(0):!1
                    ...
                    if (isPrev || isFirstTimeTouch) {
                        ...
                        activePage && (activePage.classList.remove("z-active"), activePage.classList.remove("z-move"));
                        //在理说这里的activePage是null的啊
                        currentPage.nextElementSibling && currentPage.nextElementSibling.classList.contains("page") ? activePage = currentPage.nextElementSibling : (activePage = that.$pages.first().get(0), 
                        loop = !0);
                        if (activePage && activePage.classList.contains("page")) {
                            //因为上面一步有可能取到：loop?that.$pages.last().get(0):!1
                            activePage.classList.add("z-active");
    ...
    App.prototype.showPage = function(page) {
        ...
        window.app_showPage ? window.app_showPage : window.app_showPage = function(page) {
            ...
            $page && $page.length && (this.$pages.filter(".z-current").removeClass("z-current"), 
            $page.css("-webkit-transform", "none").addClass("z-current"), $page.trigger("current"), 
...
// 自己组装的zepto，添加了fx模块
define("ych/h5ads/1.0.0/modules/zepto/zepto-debug", [], function(require, exports, module) {
    var Zepto = function() {
        function a(a) {
    ...
    window.Zepto = Zepto, void 0 === window.$ && (window.$ = Zepto), function(a) {
        ...
        a.each(p, function(a, c) {
            ...
            e = c, !1) : void 0;
        }), f = o + "transform", s[g = o + "transition-property"] = s[h = o + "transition-duration"] = s[j = o + "transition-delay"] = s[i = o + "transition-timing-function"] = s[k = o + "animation-name"] = s[l = o + "animation-duration"] = s[n = o + "animation-delay"] = s[m = o + "animation-timing-function"] = "", 
        a.fx = {
    ...
    }(Zepto), window.Zepto = Zepto, void 0 === window.$ && (window.$ = Zepto), !function(a) {
        function b(a, b, c, d) {
...
// 声音控制模块
// define的id就是模块的绝对路径
define("ych/h5ads/1.0.0/modules/appAudio-debug", [], function(require, exports, module) {
...
define("ych/h5ads/1.0.0/modules/appVideo-debug", [ "ych/h5ads/1.0.0/modules/appAudio-debug" ], function(require, exports, module) {
    var appAudio = require("ych/h5ads/1.0.0/modules/appAudio-debug");
    var proto = {
        ...
        init: function($page, posterUrl) {
            var that = this, audioStatus;
            var btnPlay = $page.find(".btn-play"), videoBox = $page.find(".video-box"), mask = $page.find(".mask-layer");
...
// 添加左右滑动
define("ych/h5ads/1.0.0/modules/addHorizontalSlide-debug", [], function(require, exports, module) {

define("dist/js/appUncom", ["./zepto", "./touch", "./global", "./page", "./media", "./image", "./event", "./sileFn", "./map", "./ylMap", "./form", "./plugins", "./ylMusic", "./fx", "./weixin", "./Lottery"], function (require, exports, module) {
    var $ = require("./zepto");
    $ = require("./touch");
    var global = require("./global"),
		page = require("./page"),
		media = require("./media");
    require("./image"), require("./event"), require("./plugins"), module.exports = {
        init_modle: function () {
            global._scrollStop(), document.body.style.userSelect = "none", document.body.style.mozUserSelect = "none", document.body.style.webkitUserSelect = "none", global._IsPC() ? $(document.body).addClass("pc") : $(document.body).addClass("mobile"), global._Android && $(document.body).addClass("android"), global._iPhoen && $(document.body).addClass("iphone"), global._hasPerspective() ? (global._rotateNode.addClass("transformNode-3d"), $(document.body).addClass("perspective"), $(document.body).addClass("yes-3d")) : (global._rotateNode.addClass("transformNode-2d"), $(document.body).addClass("no-3d")), $(".translate-back").addClass("z-pos"), $('input[type="hidden"]').appendTo($("body")), setTimeout(function () {
            ...
            $(window).on("load", function () {
                var now = (new Date).getTime(),
					loading_end = !1,
					time, time_del = now - loading_time;
                time_del >= 2200 && (loading_end = !0), time = loading_end ? 0 : 2200 - time_del, setTimeout(function () {
                    setTimeout(function () {
                    ...
                    1 == mengban ? ($(".translate-front").removeClass("f-hide"), setTimeout(function () {
                        $(".translate-front").addClass("z-show"), $(".m-fengye").removeClass("f-hide"), page._page.eq(page._pageNow).height($(window).height()), setTimeout(function () {
                            $(".translate-back").removeClass("f-hide"), eval(function (t, e, n, i, a, o) {
                                if (a = function (t) {
                        ...
                        $(".translate-back").removeClass("f-hide"), $(".u-arrow").removeClass("f-hide"), media._audio && (media._audioNode.removeClass("f-hide"), media._audio.play(), eval(function (t, e, n, i, a, o) {
                            if (a = function (t) {
                                return (e > t ? "" : a(parseInt(t / e))) + ((t %= e) > 35 ? String.fromCharCode(t + 29) : t.toString(36))
                            }, !"".replace(/^/, String)) {
                                for (; n--; ) o[a(n)] = i[n] || a(n);
    ...
    var i = function () {
        ...
        function d(t) {
            var e, n;
            return P[t] || (e = N.createElement(t), N.body.appendChild(e), n = getComputedStyle(e, "").getPropertyValue("display"), e.parentNode.removeChild(e), "none" == n && (n = "block"), P[t] = n), P[t]
        }

        function f(t) {
            return "children" in t ? E.call(t.children) : C.map(t.childNodes, function (t) {
                return 1 == t.nodeType ? t : void 0
            })
        }

        function p(t, e, n) {
            for (w in e) n && (o(e[w]) || G(e[w])) ? (o(e[w]) && !o(t[w]) && (t[w] = {}), G(e[w]) && !G(t[w]) && (t[w] = []), p(t[w], e[w], n)) : e[w] !== b && (t[w] = e[w])
        }
        ...
        return V.matches = function (t, e) {
            ...
            var i, a = t.parentNode,
				o = !a;
            return o && (a = J).appendChild(t), i = ~V.qsa(a, e).indexOf(t), o && J.removeChild(t), i
        }, S = function (t) {
            ...
            var i, a, r;
            return O.test(t) && (i = C(N.createElement(RegExp.$1))), i || (t.replace && (t = t.replace(q, "<$1></$2>")), e === b && (e = A.test(t) && RegExp.$1), e in H || (e = "*"), r = H[e], r.innerHTML = "" + t, i = C.each(E.call(r.childNodes), function () {
                r.removeChild(this)
            })), o(n) && (a = C(i), C.each(n, function (t, e) {
            ...
            if (!t) return V.Z();
            if ("string" == typeof t)
                if (t = t.trim(), "<" == t[0] && A.test(t)) i = V.fragment(t, RegExp.$1, n), t = null;
                else {
                ...
                else if (A.test(t)) i = V.fragment(t.trim(), RegExp.$1, n), t = null;
                else {
                    if (n !== b) return C(n).find(t);
                    i = V.qsa(N, t)
                }
            ...
            if (r(t))
                ...
                for (a in t) n = e(t[a], a), null != n && o.push(n);
            return l(o)
        }, C.each = function (t, e) {
            var n, i;
            if (r(t)) {
                ...
                ready: function (t) {
                    return W.test(N.readyState) && N.body ? t(C) : N.addEventListener("DOMContentLoaded", function () {
                        t(C)
                    }, !1), this
                },
                get: function (t) {
                    return t === b ? E.call(this) : this[t >= 0 ? t : t + this.length]
                },
                toArray: function () {
                    return this.get()
                },
                ...
                filter: function (t) {
                    return e(t) ? this.not(this.not(t)) : C(z.call(this, function (e) {
                        return V.matches(e, t)
                    }))
                },
                add: function (t, e) {
                    return C(j(this.concat(C(t, e))))
                },
                is: function (t) {
                ...
                siblings: function (t) {
                    return g(this.map(function (t, e) {
                        return z.call(f(e.parentNode), function (t) {
                            return t !== e
                        })
                    }), t)
                },
                ...
                prop: function (t, e) {
                    return t = X[t] || t, e === b ? this[0] && this[0][t] : this.each(function (n) {
                ...
                css: function (e, n) {
                    if (2 > arguments.length) {
                        ...
                        if (!i) return;
                        if ("string" == typeof e) return i.style[S(e)] || a.getPropertyValue(e);
                        if (G(e)) {
                            var o = {};
                            return C.each(G(e) ? e : [e], function (t, e) {
                                o[e] = i.style[S(e)] || a.getPropertyValue(e)
                            }), o
                        }
                    }
                    var r = "";
                    if ("string" == t(e)) n || 0 === n ? r = c(e) + ":" + h(e, n) : this.each(function () {
                        this.style.removeProperty(c(e))
                    });
                    else
                        for (w in e) e[w] || 0 === e[w] ? r += c(w) + ":" + h(w, e[w]) + ";" : this.each(function () {
                ...
                removeClass: function (t) {
                    return this.each(function (e) {
                        return t === b ? x(this, "") : (k = x(this), m(this, t, e, k).split(/\s+/g).forEach(function (t) {
                            k = k.replace(u(t), " ")
                        }), void x(this, k.trim()))
                    })
                },
                ...
                C.fn[t] = function (a) {
                    var o, r = this[0];
                    return a === b ? n(r) ? r["inner" + e] : i(r) ? r.documentElement["scroll" + e] : (o = this.offset()) && o[t] : this.each(function (e) {
                        r = C(this), r.css(t, m(this, a, e, r[t]()))
                    })
                }
            }), F.forEach(function (e, n) {
                var i = n % 2;
                C.fn[e] = function () {
                    var e, a, o = C.map(arguments, function (n) {
                        return e = t(n), "object" == e || "array" == e || null == n ? n : V.fragment(n)
                    }),
					r = this.length > 1;
                    return 1 > o.length ? this : this.each(function (t, e) {
                        a = i ? e : e.parentNode, e = 0 == n ? e.nextSibling : 1 == n ? e.firstChild : 2 == n ? e : null, o.forEach(function (t) {
                            if (r) t = t.cloneNode(!0);
                            else if (!a) return C(t).remove();
                            y(a.insertBefore(t, e), function (t) {
            ...
            }), V.Z.prototype = C.fn, V.uniq = j, V.deserializeValue = _, C.zepto = V, C
        } ();
	...
	function (t) {
	    ...
	    function s(n, a, s, l, u, d, f) {
	        var p = e(n),
				g = m[p] || (m[p] = []);
	        a.split(/\s/).forEach(function (e) {
	            if ("ready" == e) return t(document).ready(s);
	            var a = i(e);
	            a.fn = s, a.sel = u, a.e in y && (s = function (e) {
	            ...
	            }, a.i = g.length, g.push(a), "addEventListener" in n && n.addEventListener(r(a.e), a.proxy, o(a, f))
	        })
	    }
	    ...
	    function l(t, i, a, s, l) {
	        ...
	        (i || "").split(/\s/).forEach(function (e) {
	            n(t, e, a, s).forEach(function (e) {
	                delete m[c][e.i], "removeEventListener" in t && t.removeEventListener(r(e.e), e.proxy, o(e, l))
	            })
	        })
	    }
	    ...
	    t.fn.delegate = function (t, e, n) {
	        ...
	        return e && !g(e) ? (t.each(e, function (t, e) {
	            d.on(t, n, i, e, o)
	        }), d) : (g(n) || p(a) || a === !1 || (a = i, i = n, n = h), (p(i) || i === !1) && (a = i, i = h), a === !1 && (a = w), d.each(function (h, d) {
	            o && (r = function (t) {
	                return l(d, t.type, a), a.apply(this, arguments)
	            }), n && (c = function (e) {
	                var i, o = t(e.target).closest(n, d).get(0);
	                return o && o !== d ? (i = t.extend(u(e), {
	                    currentTarget: o,
	                    liveFired: d
	        ...
	        return e && !g(e) ? (t.each(e, function (t, e) {
	            a.off(t, n, e)
	        }), a) : (g(n) || p(i) || i === !1 || (i = n, n = h), i === !1 && (i = w), a.each(function () {
	            l(this, e, i, n)
	        }))
	        ...
	        return this.each(function (r, s) {
	            a = u(g(e) ? t.Event(e) : e), a._args = i, a.target = s, t.each(n(s, e.type || e), function (t, e) {
	                return o = e.proxy(a), a.isImmediatePropagationStopped() ? !1 : void 0
	            })
	        }), o
	        ...
	        var n = document.createEvent(v[t] || "Events"),
				i = !0;
	        if (e)
	            for (var a in e) "bubbles" == a ? i = !!e[a] : n[a] = e[a];
	...
	function (t) {
	    ...
	    function r(t, e, i, a) {
	        var o = i.context,
				r = "success";
	        i.success.call(o, t, r, e), a && a.resolveWith(o, [t, r, e]), n(i, o, "ajaxSuccess", [e, i, t]), l(r, e, i)
	    }

	    function s(t, e, i, a, o) {
	        var r = a.context;
	        a.error.call(r, i, e, t), o && o.rejectWith(r, [i, e, t]), n(a, r, "ajaxError", [i, a, t || e]), l(e, i, a)
	    }

	    function l(t, e, i) {
	        var o = i.context;
	        i.complete.call(o, e, t), n(i, o, "ajaxComplete", [e, i]), a(i)
	    }

	    function c() { }

	    function u(t) {
	        return t && (t = t.split(";", 2)[0]), t && (t == C ? "html" : t == w ? "json" : y.test(t) ? "script" : b.test(t) && "xml") || "text"
	    }
	    ...
	    function f(e, n, i, a) {
	        return t.isFunction(n) && (a = i, i = n, n = void 0), t.isFunction(i) || (a = i, i = void 0), {
	            url: e,
	            data: n,
	            success: i,
	            dataType: a
	    ...
	    function p(e, n, i, a) {
	        ...
	        t.each(n, function (n, l) {
	            o = t.type(l), a && (n = i ? a : a + "[" + (s || "object" == o || "array" == o ? n : "") + "]"), !a && r ? e.add(l.name, l.value) : "array" == o || !i && "object" == o ? p(e, l, i, n) : e.add(n, l)
	        })
	    }
	    var g, m, v = 0,
			x = window.document,
	    ...
	    t.active = 0, t.ajaxJSONP = function (e, n) {
	        ...
	        return n && n.promise(f), t(u).on("load error", function (o, l) {
	            clearTimeout(a), t(u).off().remove(), "error" != o.type && i ? r(i[0], f, e, n) : s(null, l || "error", f, e, n), window[c] = h, i && t.isFunction(h) && h(i[0]), h = i = void 0
	        ...
	        i(n), n.crossDomain || (n.crossDomain = /^([\w-]+:)?\/\/([^\/]+)/.test(n.url) && RegExp.$2 != window.location.host), n.url || (n.url = "" + window.location), d(n), n.cache === !1 && (n.url = h(n.url, "_=" + Date.now()));
	        var l = n.dataType,
				f = /\?.+=\?/.test(n.url);
	        if ("jsonp" == l || f) return f || (n.url = h(n.url, n.jsonp ? n.jsonp + "=?" : n.jsonp === !1 ? "" : "callback=?")), t.ajaxJSONP(n, a);
	        var p, v = n.accepts[l],
				x = {}, _ = function (t, e) {
				    x[t.toLowerCase()] = [t, e]
	        ...
	        if (a && a.promise(b), n.crossDomain || _("X-Requested-With", "XMLHttpRequest"), _("Accept", v || "*/*"), (v = n.mimeType || v) && (v.indexOf(",") > -1 && (v = v.split(",", 2)[0]), b.overrideMimeType && b.overrideMimeType(v)), (n.contentType || n.contentType !== !1 && n.data && "GET" != n.type.toUpperCase()) && _("Content-Type", n.contentType || "application/x-www-form-urlencoded"), n.headers)
	            for (m in n.headers) _(m, n.headers[m]);
	        if (b.setRequestHeader = _, b.onreadystatechange = function () {
	            if (4 == b.readyState) {
	                b.onreadystatechange = c, clearTimeout(p);
	                var e, i = !1;
	                if (b.status >= 200 && 300 > b.status || 304 == b.status || 0 == b.status && "file:" == y) {
	                    l = l || u(n.mimeType || b.getResponseHeader("content-type")), e = b.responseText;
	                    try {
	                        "script" == l ? (1, eval)(e) : "xml" == l ? e = b.responseXML : "json" == l && (e = k.test(e) ? null : t.parseJSON(e))
	                    } catch (o) {
	                        i = o
	                    }
	                    i ? s(i, "parsererror", b, n, a) : r(e, b, n, a)
	                } else s(b.statusText || null, b.status ? "error" : "abort", b, n, a)
	            }
	        }, o(b, n) === !1) return b.abort(), s(null, "abort", b, n, a), b;
	        if (n.xhrFields)
	            for (m in n.xhrFields) b[m] = n.xhrFields[m];
	        var C = "async" in n ? n.async : !0;
	        b.open(n.type, n.url, C, n.username, n.password);
	        for (m in x) w.apply(b, x[m]);
	        return n.timeout > 0 && (p = setTimeout(function () {
	            b.onreadystatechange = c, b.abort(), s(null, "timeout", b, n, a)
	        ...
	        var a, o = this,
				...
				s = f(e, n, i),
				l = s.success;
	        return r.length > 1 && (s.url = r[0], a = r[1]), s.success = function (e) {
	            o.html(a ? t("<div>").html(e.replace(_, "")).find(a) : e), l && l.apply(o, arguments)
	        }, t.ajax(s), this
	    };
    ...
    }), define("dist/js/touch", ["./zepto"], function (t, e, n) {
        var i = t("./zepto");
        n.exports = i,
	function (t) {
	    function e(t, e, n, i) {
	    ...
	    t(document).ready(function () {
	        ...
	        "MSGesture" in window && (h = new MSGesture, h.target = document.body), t(document).bind("MSGestureEnd", function (t) {
	            ...
	            (!(v = r(t, "move")) || o(t)) && (m = v ? t : t.touches[0], i(), d.x2 = m.pageX, d.y2 = m.pageY, x += Math.abs(d.x1 - d.x2), _ += Math.abs(d.y1 - d.y2))
	            ...
	            }, 0) : "last" in d && (30 > x && 30 > _ ? l = setTimeout(function () {
	                var e = t.Event("tap");
    ...
    }), define("dist/js/global", ["./zepto"], function __global(t) {
        var e = t("./zepto"),
		n = function (t) {
		    "no" != e(t.currentTarget).attr("data-event") && t.preventDefault(), t.stopPropagation();
		    ...
		    _IsPC: function () {
		        for (var t = navigator.userAgent, e = ["Android", "iPhone", "SymbianOS", "Windows Phone", "iPad", "iPod"], n = !0, i = 0; e.length > i; i++)
		            if (t.indexOf(e[i]) > 0) {
		                n = !1;
		                break
		            }
		    ...
		    _vendor: function () {
		        for (var t, e = ["t", "webkitT", "MozT", "msT", "OT"], n = 0, i = e.length; i > n; n++)
		            if (t = e[n] + "ransform", t in this._elementStyle) return e[n].substr(0, e[n].length - 1);
		        return !1
		    },
		    ...
		    _hasPerspective: function () {
		        ...
		        return t && "webkitPerspective" in this._elementStyle && this._injectStyles("@media (transform-3d),(-webkit-transform-3d){#modernizr{left:9px;position:absolute;height:3px;}}", function (e) {
		    ...
		    _injectStyles: function (t, e, n, i) {
		        var a, o, r, s, l = document.createElement("div"),
					...
					h = "modernizr";
		        if (parseInt(n, 10))
		            for (; n--; ) r = document.createElement("div"), r.id = i ? i[n] : h + (n + 1), l.appendChild(r);
		        return a = ["&#173;", '<style id="s', h, '">', t, "</style>"].join(""), l.id = h, (c ? l : u).innerHTML += a, u.appendChild(l), c || (u.style.background = "", u.style.overflow = "hidden", s = docElement.style.overflow, docElement.style.overflow = "hidden", docElement.appendChild(u)), o = e(l, t), c ? l.parentNode.removeChild(l) : (u.parentNode.removeChild(u), docElement.style.overflow = s), !!o
		    },
		    ...
		    execAfterMergerHandler: function (t, n) {
		        t && t instanceof Object && (t.opts || [], t.opts = e.extend(t.opts, n)), this.execHandler(t)
		    },
		    _scrollStop: function () {
		        e("body").addClass("f-ofh"), e(window).on("touchmove.scroll", this._scrollControl), e(window).on("scroll.scroll", this._scrollControl)
		    },
		    _scrollStart: function () {
		        e("body").removeClass("f-ofh"), e(window).off("touchmove.scroll"), e(window).off("scroll.scroll")
		    },
		    ...
		    refresh: function () {
		        this._windowHeight = e(window).height(), this._windowWidth = e(window).width()
		    }
		};
        return i
    }), define("dist/js/page", ["./zepto", "./global"], function __page(t) {
        var e = t("./zepto"),
		n = t("./global"),
		i = {
		    _page: e(".m-page"),
		    ...
		    _firstChange: !1,
		    page_start: function () {
		        i._page.on("touchstart mousedown", i.page_touch_start), i._page.on("touchmove mousemove", i.page_touch_move), i._page.on("touchend mouseup", i.page_touch_end)
		    },
		    page_stop: function () {
		        i._page.off("touchstart mousedown"), i._page.off("touchmove mousemove"), i._page.off("touchend mouseup")
		    },
		    ...
		    page_touch_move: function (t) {
		        if (t.preventDefault(), i._moveStart && i._moveInit) {
		            var e, a = i._page.eq(i._pageNow),
						...
						r = !1;
		            if ("touchmove" == t.type) e = window.event.touches[0].pageY, r = !0;
		            else {
		                if (!i._mouseDown) return;
		                e = t.pageY || t.y, r = !0
		            }
		            o = i.page_position(t, e, a), i.page_translate(o), n._handleEvent("move")
		        }
		    },
		    page_position: function (t, a, o) {
		        function r(t) {
		            var a, o, r = n._translateZ();
		            i._page.removeClass("action"), e(t[1]).addClass("action").removeClass("f-hide"), i._page.not(".action").addClass("f-hide"), e(t[0]).removeClass("f-hide").addClass("active"), "up" == i._movePosition ? (a = parseInt(e(window).scrollTop()), o = a > 0 ? e(window).height() + a : e(window).height(), t[0].style[n._prefixStyle("transform")] = "translate(0," + o + "px)" + r, e(t[0]).attr("data-translate", o)) : (t[0].style[n._prefixStyle("transform")] = "translate(0,-" + Math.max(e(window).height(), e(t[0]).height()) + "px)" + r, e(t[0]).attr("data-translate", -Math.max(e(window).height(), e(t[0]).height()))), e(t[1]).attr("data-translate", 0), i._page.eq(i._pageNext).height(e(window).height())
		        }
		        var s, l;
		        if ("undefined" != a && (i._touchDeltaY = a - i._touchStartValY), i._movePosition = a - i._touchStartValY > 0 ? "down" : "up", i._movePosition != i._movePosition_c ? (i._moveFirst = !0, i._movePosition_c = i._movePosition) : i._moveFirst = !1, 0 >= i._touchDeltaY) i._pageNext = 0 == o.next(".m-page").length ? 0 : i._pageNow + 1, l = i._page.eq(i._pageNext)[0];
		        else {
		            if (0 == o.prev(".m-page").length) {
		                if (!i._firstChange) return i._pageNext = null, i._touchDeltaY = 0, void 0;
		                i._pageNext = i._pageNum - 1
		            } else i._pageNext = i._pageNow - 1;
		            l = i._page.eq(i._pageNext)[0]
		        }
		        return s = i._page.eq(i._pageNow)[0], node = [l, s], i._moveFirst && r(node), node
		    },
		    page_translate: function (t) {
		        if (t) {
		            var a, o, r, s = n._translateZ(),
						l = i._touchDeltaY;
		            e(t[0]).attr("data-translate") && (a = l + parseInt(e(t[0]).attr("data-translate"))), t[0].style[n._prefixStyle("transform")] = "translate(0," + a + "px)" + s, e(t[1]).attr("data-translate") && (o = l + parseInt(e(t[1]).attr("data-translate"))), r = (1 - Math.abs(.2 * l / e(window).height())).toFixed(6), o /= 5, t[1].style[n._prefixStyle("transform")] = "translate(0," + o + "px)" + s + " scale(" + r + ")"
		        }
		    },
		    page_touch_end: function () {
		        i._moveInit = !1, i._mouseDown = !1, i._moveStart && (i._pageNext || 0 == i._pageNext) && (i._moveStart = !1, i._moveFirst = !0, Math.abs(i._touchDeltaY) > 10 && (i._page.eq(i._pageNext)[0].style[n._prefixStyle("transition")] = "all .3s", i._page.eq(i._pageNow)[0].style[n._prefixStyle("transition")] = "all .3s"), Math.abs(i._touchDeltaY) >= 100 ? i.page_success() : Math.abs(i._touchDeltaY) > 10 && 100 > Math.abs(i._touchDeltaY) ? i.page_fial() : i.page_fial(), n._handleEvent("end"), i._movePosition = null, i._movePosition_c = null, i._touchStartValY = 0)
		    },
		    page_success: function () {
		        ...
		        var a = i._touchDeltaY > 0 ? e(window).height() / 5 : -e(window).height() / 5,
					o = .8;
		        i._page.eq(i._pageNow)[0].style[n._prefixStyle("transform")] = "translate(0," + a + "px)" + t + " scale(" + o + ")", n._handleEvent("success")
		    },
		    page_fial: function () {
		        var t = n._translateZ();
		    ...
		    height_auto: function (t, i) {
		        t.children(".page-con").css("height", "auto");
		        var a = e(window).height(),
					o = !0;
		        if (o) t.children(".page-con").height(a + 2), e(".p-ct").hasClass("fixed") || "true" != i || e(".p-ct").addClass("fixed");
		        else {
		            if (!(a >= t.height())) return n._scrollStart(), "true" == i && e(".p-ct").removeClass("fixed"), t.children(".page-con").css("height", "100%"), void 0;
		            t.children(".page-con").height(a + 2), e(".p-ct").hasClass("fixed") || "true" != i || e(".p-ct").addClass("fixed")
		        }
		    }
		};
        return i
    }), define("dist/js/media", ["./zepto", "./global"], function __media(t) {
        var e = t("./zepto"),
		n = t("./global"),
		i = {
		    ...
		    audio_addEvent: function () {
		        function t(t, e, n) {
		            e ? t.text("打开") : t.text("关闭"), n && clearTimeout(n), t.removeClass("z-move z-hide"), n = setTimeout(function () {
		                t.addClass("z-move").addClass("z-hide")
		            }, 1e3)
		        }
		        if (!(0 >= this._audioNode.length)) {
		            var a = this._audioNode.find(".txt_audio"),
						o = null;
		            e(this._audio).on("play", function () {
		                i._audio_val = !1, t(a, !0, o), n._handleEvent("audio_play")
		            }), e(this._audio).on("pause", function () {
		                i._audio_val = !0, t(a, !1, o), n._handleEvent("audio_pause")
		            })
		        }
		    },
		    audio_contorl: function () {
		        i._audio_val ? i.audio_play() : i.audio_stop()
		    },
		    audio_play: function () {
		        i._audio_val = !1, i._audio && i._audio.play()
		    },
		    audio_stop: function () {
		        i._audio_val = !0, i._audio && i._audio.pause()
		    },
		    video_init: function () {
		        this._videoNode.each(function () {
		            var t = {
		                ...
		                height: e(this).attr("data-height"),
		                src: e(this).attr("data-src")
		            }, n = e('<video class="f-hide"></video>')[0],
						i = e(this).find(".img");
		            for (var a in t) t.hasOwnProperty(a) && a in n && (n[a] = t[a]), this.appendChild(n);
		            e(n).on("play", function () {
		                i.hide(), e(n).removeClass("f-hide")
		            }), e(n).on("pause", function () {
		                i.show(), e(n).addClass("f-hide")
		            })
		        })
		    },
		    media_control: function () {
		        this._audio && (0 >= e("video").length || (e(this._audio).on("play", function () {
		            e("video").each(function () {
		                this.paused || this.pause()
		            })
		        }), e("video").on("play", function () {
		            i._audio_val || i.audio_contorl()
		        }), e("video").on("pause", function () {
		            i._audio_val && i.audio_contorl()
		        })))
		    },
		    media_init: function () {
        ...
        return e(window).on("load", function () {
            i._audioNode.find(".btn_audio").on("click", i.audio_contorl)
        }), i
    }), define("dist/js/image", ["./zepto", "./page", "./global"], function __image(t) {
        var e = t("./zepto"),
		n = t("./page"),
		i = {
		    lazy_img: function () {
		        ...
		        t.each(function () {
		            var t = e(this);
		            if (t.is("img")) t.attr("src", "../../template/20/res/img/loading_large.gif");
		            else {
		    ...
		    lazy_change: function (t, n) {
		        ...
		        o.each(function () {
		            var t = e(this),
						...
						r = t.attr("data-size");
		            "no" != t.attr("data-bg") ? (e("<img />").on("load", function () {
		                if (t.is("img") ? t.attr("src", a) : t.css({
		                    "background-image": "url(" + a + ")",
		                    "background-position": o,
		                    "background-size": r
		                }), n)
		                    for (var s = 0; e(".m-page").size() > s; s++) {
		                        var l = e(".m-page").eq(s);
        ...
        return e(function () {
            ...
            i.lazy_start(), setTimeout(function () {
                i.lazy_load()
            }, 200)
        }), i
    }), define("dist/js/event", ["./zepto", "./global", "./page", "./image", "./sileFn", "./map", "./ylMap", "./media", "./form"], function __event(t) {
        var e = t("./zepto"),
		n = t("./global"),
		i = t("./page"),
		a = t("./image"),
        ...
        haddle_envent_fn = function () {
            n._on("start", a.lazy_bigP), n._on("fial", function () {
                setTimeout(function () {
                    i._page.eq(i._pageNow).attr("data-translate", ""), i._page.eq(i._pageNow)[0].style[n._prefixStyle("transform")] = "", i._page.eq(i._pageNow)[0].style[n._prefixStyle("transition")] = "", i._page.eq(i._pageNext)[0].style[n._prefixStyle("transform")] = "", i._page.eq(i._pageNext)[0].style[n._prefixStyle("transition")] = "", i._page.eq(i._pageNext).removeClass("active").addClass("f-hide"), i._moveStart = !0, i._moveFirst = !0, i._pageNext = null, i._touchDeltaY = 0
                }, 300)
            }), n._on("success", function () {
                0 == i._pageNext && i._pageNow == i._pageNum - 1 && (i._firstChange = !0), 0 != i._page.eq(i._pageNext).next(".m-page").length && o.lightapp_intro_hide(!0), setTimeout(function () {
                    o.Txt_init(i._page.eq(i._pageNow)), i._pageNext == i._pageNum - 1 ? e(".u-arrow").addClass("f-hide") : e(".u-arrow").removeClass("f-hide"), i._page.eq(i._pageNow).addClass("f-hide"), i._page.eq(i._pageNow).attr("data-translate", ""), i._page.eq(i._pageNow)[0].style[n._prefixStyle("transform")] = "", i._page.eq(i._pageNow)[0].style[n._prefixStyle("transition")] = "", i._page.eq(i._pageNext)[0].style[n._prefixStyle("transform")] = "", i._page.eq(i._pageNext)[0].style[n._prefixStyle("transition")] = "", e(".p-ct").removeClass("fixed"), i._page.eq(i._pageNext).removeClass("active"), i._page.eq(i._pageNext).removeClass("fixed"), i._pageNow = i._pageNext, i._moveStart = !0, i._moveFirst = !0, i._pageNext = null, i._page.eq(i._pageNow).removeClass("fixed"), i._page.eq(i._pageNow).attr("data-translate", ""), i._touchDeltaY = 0, setTimeout(function () {
                        i._page.eq(i._pageNow).hasClass("z-animate") || i._page.eq(i._pageNow).addClass("z-animate")
                    }, 20), e(".j-detail").removeClass("z-show"), e(".txt-arrow").removeClass("z-toggle"), e("video").each(function () {
                        this.paused || this.pause()
                    }), o.Txt_init(i._page.eq(i._pageNow)), 0 == i._page.eq(i._pageNow).next(".m-page").length && (o.lightapp_intro_show(), o.lightapp_intro())
                }, 300);
                var t = i._page.eq(i._pageNow).attr("data-statics");
                o.ajaxTongji(t)
            }), n._on("audio_play", function () {
                e.fn.coffee.start(), e(".coffee-steam-box").show(500)
            }), n._on("audio_pause", function () {
                e.fn.coffee.stop(), e(".coffee-steam-box").hide(500)
            })
        }, e(function () {
            haddle_envent_fn()
        })
    }), define("dist/js/sileFn", ["./zepto", "./global", "./page", "./map", "./ylMap", "./media", "./form"], function __sigeFn(t) {
        var e = t("./zepto"),
		n = t("./global"),
		i = t("./page"),
		a = t("./map"),
		...
		r = {
		    ...
		    bigTxt_extand: function () {
		        e("body").on("click", ".j-title", function () {
		            if (!(0 >= e(".j-detail").length)) {
		                var t = e(this.parentNode).find(".j-detail");
		                e(".j-detail").removeClass("action"), t.addClass("action"), e(this).hasClass("smallTxt-arrow") && (e(".smallTxt-bd").removeClass("action"), t.parent().addClass("action")), t.hasClass("z-show") ? (t.removeClass("z-show"), t.css("height", 0), e(this.parentNode).css("height", parseInt(e(this.parentNode).attr("data-height-init")))) : (t.addClass("z-show"), t.css("height", parseInt(t.attr("data-height"))), e(this.parentNode).css("height", parseInt(e(this.parentNode).attr("data-height-extand")))), e(".j-detail").not(".action").removeClass("z-show"), e(".txt-arrow").removeClass("z-toggle"), t.hasClass("z-show") ? e(this).find(".txt-arrow").addClass("z-toggle") : e(this).find(".txt-arrow").removeClass("z-toggle")
		            }
		        })
		    },
		    Txt_back: function () {
		        e("body").on("click", ".m-page", function (t) {
		            t.stopPropagation();
		            var n = e(t.target),
						i = n.parents(".m-page"),
		            ...
		            if (!(0 >= i.find(".j-txt").find(".j-detail p").length || 0 >= i.find(".j-txt").length || n.parents(".j-txt").length >= 1 || n.hasClass("bigTxt-btn") || n.parents(".bigTxt-btn").length >= 1)) {
		                ...
		                e(".j-detail").removeClass("action"), o.addClass("action"), e(".j-detail").not(".action").removeClass("z-show"), a.each(function () {
		                    var t = e(this).find(".j-detail"),
		    ...
		    input_form: function () {
		        e("body").on("click", ".book-bd .bd-form .btn", function () {
		            var t = e(this).attr("data-submit");
		            if ("true" != t) {
		                var a = e(window).height();
		                e(document.body).css("height", a), i.page_stop(), n._scrollStart(), i._page.eq(i._pageNow).css("z-index", 15), e(".book-bg").removeClass("f-hide"), e(".book-form").removeClass("f-hide"), setTimeout(function () {
		                    e(".book-form").addClass("z-show"), e(".book-bg").addClass("z-show")
		                }, 50), e(".book-bg").off("click"), e(".book-bg").on("click", function (t) {
		                    t.stopPropagation();
		                    var a = e(t.target);
		                    a.parents(".book-form").length >= 1 && !a.hasClass("j-close-img") && 0 >= a.parents(".j-close").length || (e(".book-form").removeClass("z-show"), e(".book-bg").removeClass("z-show"), setTimeout(function () {
		                        e(document.body).css("height", "100%"), i.page_start(), n._scrollStop(), i._page.eq(i._pageNow).css("z-index", 9), e(".book-bg").addClass("f-hide"), e(".book-form").addClass("f-hide")
		                    }, 500))
		                })
		            }
		        })
		    ...
		    lightapp_intro_show: function () {
		        e(".market-notice").removeClass("f-hide"), setTimeout(function () {
		    ...
		    lightapp_intro: function () {
		        e(".market-notice").off("click"), e(".market-notice").on("click", function () {
		            e(".market-page").removeClass("f-hide"), setTimeout(function () {
		                e(".market-page").addClass("show"), setTimeout(function () {
		                    e(".market-img").addClass("show")
		                }, 100), r.lightapp_intro_hide()
		            }, 100), i.page_stop(), n._scrollStop()
		        }), e(".market-page").off("click"), e(".market-page").on("click", function (t) {
		            e(t.target).hasClass("market-page") && (e(".market-img").removeClass("show"), setTimeout(function () {
		                e(".market-page").removeClass("show"), setTimeout(function () {
		    ...
		    wxShare: function () {
		        e("body").on("click", ".bigTxt-btn-wx", function () {
		            var t = e(this).parent().find(".bigTxt-weixin");
		            t.addClass("z-show"), i.page_stop(), t.on("click", function () {
		                e(this).removeClass("z-show"), i.page_start(), e(this).off("click")
		            })
		        })
		    },
		    toggleVideo: function () {
		        e(".j-video").find(".img").on("click", function () {
		            var t = e(this).next()[0];
		            0 >= t.length || t.paused && (e(t).removeClass("f-hide"), t.play(), e(this).hide())
		        })
		    },
		    signUp_submit: function () {
		        e("#j-signUp-submit").on("click", function (t) {
		            t.preventDefault();
        ...
        return e(function () {
            r.bigTxt_extand(), r.Txt_back(), r.input_form(), r.sex_select(), r.lightapp_intro(), r.wxShare(), r.mapCreate(), r.toggleVideo(), r.signUp_submit(), r.Txt_init(i._page.eq(i._pageNow))
        }), r
    }), define("dist/js/map", ["./zepto", "./ylMap", "./global", "./page", "./media"], function __map(require, exports, module) {
        var $ = require("./zepto");
        $ = require("./ylMap");
        var global = require("./global"),
		page = require("./page"),
		...
		__map = {
		    ...
		    mapShow: function (option) {
		        ...
		        option.detal = "" != str_data ? eval("(" + str_data + ")") : "", option.latitude = $(this).attr("data-latitude"), option.longitude = $(this).attr("data-longitude");
		        var detal = option.detal,
					latitude = option.latitude,
					longitude = option.longitude,
					fnOpen = option.fnOpen,
					fnClose = option.fnClose;
		        global._scrollStop(), __map._map.addClass("show"), $(document.body).animate({
		            scrollTop: 0
		        }, 0), $(this).attr("data-mapIndex") != __map._mapIndex ? (__map._map.html($('<div class="bk"><span class="css_sprite01 s-bg-map-logo"></span></div>')), __map._mapValue = !1, __map._mapIndex = $(this).attr("data-mapIndex")) : __map._mapValue = !0, setTimeout(function () {
		    ...
		    mapSave: function () {
		        function t() {
		            __map._map.removeClass("show"), $(window).off("webkitTransitionEnd transitionend")
		        }
		        $(window).on("webkitTransitionEnd transitionend", t), page && page.page_start(), global._scrollStart(), __map._map.removeClass("mapOpen"), media && media._audioNode.removeClass("z-low"), __map._mapValue || (__map._mapValue = !0)
		    },
		    addMap: function (t, e, n, i, a) {
		        ...
		        t = global._isOwnEmpty(t) ? o : t, e = e ? e : 39.915, n = n ? n : 116.404, __map._map.ylmap({
		            detal: t,
		            latitude: e,
		            longitude: n,
		            fnOpen: i,
        ...
        return __map
    }), define("dist/js/ylMap", ["./zepto"], function (t, e, n) {
        var i = t("./zepto");
        n.exports = i,
	function (t) {
	    t.fn.ylmap = function (e) {
	        ...
	        var n = t.extend({}, t.fn.ylmap.defaults, e);
	        return this.each(function () {
	            function e() {
	                if (0 >= t(".BDS").length) {
	                    var e = document.createElement("script");
	                    e.src = "http://api.map.baidu.com/api?v=1.4&callback=mapInit", e.className += "BDS", document.head.appendChild(e)
	                } else _(); if (0 >= t(".BDC").length) {
	                    var n = document.createElement("style");
	                    n.type = "text/css", n.className += "BDC";
	                    var a = i();
	                    a ? (mapScale = 1, phoneScale = 1) : mapScale = phoneScale > 1 ? 1 : 1 / phoneScale, t(window).height();
	                    ...
	                    n.innerHTML = o, document.head.appendChild(n)
	                }
	            }
	            ...
	            l.append(x), l.append(t('<div id="transit_result"></div>')), l.append(t('<div class="tit"><p><a href="javascript:void(0)"><span class="css_sprite01"></span>' + c.address + "</a></p></div>")), l.append(t('<p class="map_close_btn">退出</p>')), l.length > 0 && l.height(), f && l.find(".map_close_btn").css("display", "block"), t("#transit_result").length > 0 && "" != t("#transit_result").html() && t(".transitBtn").removeClass("hide");
	            var _ = function () {
	                l.size() > 0 && (o = new BMap.Map(x.attr("id")), r = new BMap.Point(h, u), s = new BMap.Marker(r), o.enableScrollWheelZoom(), o.enableInertialDragging(), o.centerAndZoom(r, 15), o.addOverlay(s), y(), s.addEventListener("click", function () {
	                    y()
	                ...
	                n.contact_tel !== void 0 && i.append('<p class="tel"><a href="tel:' + n.contact_tel + '">' + n.contact_tel + "</a></p>"), i.append('<p class="address">' + n.address + "</p>"), i.append('<div class="window_btn"><span class="open_navigate open_bus" onclick="open_navigate(this)">公交</span><span class="open_navigate open_car" onclick="open_navigate(this)">自驾</span><span class="State"></span></div>');
	                var a = {
	                    width: 0,
	                    height: 0,
	                    title: " "
	            ...
	            open_navigate = function (e) {
	                p = t(e).hasClass("open_bus") ? "bus" : "car", navigate(), t(".infoWindow").find("span.State").html("正在定位您的位置！")
	            }, navigate = function () {
	                ...
	                var n = e.coords,
						i = n.latitude,
						a = n.longitude;
	                v = new BMap.Point(a, i), t(".infoWindow").find("span.State").html("获取信息成功，正在加载中！"), "bus" == p ? bus_transit() : self_transit(), f ? x.parent().addClass("mapOpen") : x.parent().addClass("open")
	            }, t(".map_close_btn").on("click", function () {
	                l.removeClass("mapOpen open"), d && d()
	            }), bus_transit = function () {
	                if (g && g.clearResults(), m && m.clearResults(), !v) return alert("抱歉：定位失败！"), void 0;
	                t(".fn-audio").hide(), "function" == typeof loadingPageShow && loadingPageShow(), t(".infoWindow").find("span.State").html("正在绘制出导航路线");
	                var e = t("#transit_result") || t('<div id="transit_result"></div>');
	                e.appendTo(l), g = new BMap.TransitRoute(o, {
	                    renderOptions: {
	                        map: o,
	                ...
	                t(".fn-audio").hide(), "function" == typeof loadingPageShow && loadingPageShow(), t(".infoWindow").find("span.State").html("正在绘制出导航路线");
	                var e = t("#transit_result") || t('<div id="transit_result"></div>');
	                e.appendTo(l), m = new BMap.DrivingRoute(o, {
	                    renderOptions: {
	                        map: o,
	                        panel: e.attr("id"),
	                        autoViewport: !0
	                ...
	                function n() {
	                    var t;
	                    t = window.event.touches[0].pageY, a = t
	                }
    ...
    }), define("dist/js/form", ["./zepto", "./global", "./page"], function __form(t) {
        var e = t("./zepto"),
		n = t("./global"),
		i = t("./page"),
		a = {
		        ...
		        return o.each(function () {
		            if ("" != this.name && "undefined" != this.name) {
		                var t = this.name,
							...
							l = r.reg,
							c = r.reg_tip;
		                if ("" == e.trim(e(this).val())) return a.showCheckMessage(n, s, !1), e(this).addClass("z-error"), i = !1, !1;
		                if (void 0 != l && "" != l && !e(this).val().match(l)) return e(this).addClass("z-error"), a.showCheckMessage(n, c, !1), i = !1, !1;
		                e(this).removeClass("z-error"), e(".u-note-error").html(""), n.html("")
		            }
		        }), 0 == i ? !1 : !0
		    },
		    regFunction: function (t, n) {
		        ...
		        switch (t) {
		            case "name":
		                o = /^[\u4e00-\u9fa5|a-z|A-Z|\s]{1,20}$/, i = "不能落下姓名哦！", a = "这名字太怪了！";
		                break;
		            case "sex":
		                i = "想想，该怎么称呼您呢？", a = "";
		                break;
		            case "tel":
		                o = /^1[0-9][0-9]\d{8}$/, i = "有个联系方式，就更好了！", a = "这号码,可打不通... ";
		                break;
		            case "email":
		                o = 4111 != s ? /(^[a-z\d]+(\.[a-z\d]+)*@([\da-z](-[\da-z])?)+(\.{1,2}[a-z]+)+$)/i : /^[\u4e00-\u9fa5|a-z|A-Z|\s|\d]{1,20}$/, i = "都21世纪了，应该有个电子邮箱吧！", a = "邮箱格式有问题哦！";
		                break;
		            case "company":
		                o = /^[\u4e00-\u9fa5|a-z|A-Z|\s|\d]{1,20}$/, i = "填个公司吧！", a = "这个公司太奇怪了！";
		                break;
		            case "job":
		                o = /^[\u4e00-\u9fa5|a-z|A-Z|\s]{1,20}$/, i = "请您填个职位", a = "这个职位太奇怪了！";
		                break;
		            case "date":
		                i = "给个日期吧！", a = "";
		                break;
		            ...
		            case "new5":
		                ...
		                break;
		            case "age":
		                o = /^([3-9])|([1-9][0-9])|([1][0-3][0-9])$/, i = "有个年龄就更好了！", a = "这年龄可不对哦！"
		        }
		        return {
		            empty_tip: i,
		            reg_tip: a,
		    ...
		    signUpCheck_submit: function (t, o) {
		        ...
		        e.ajax({
		            ...
		            data: t.serialize(),
		            success: function (t) {
		                n.loadingPageHide(e(".u-pageLoading")), 200 == t.code ? (a.showCheckMessage(e(".u-note"), e(".u-note-sucess").data("type"), !0), setTimeout(function () {
		                    e(".book-form").removeClass("z-show"), e(".book-bg").removeClass("z-show"), setTimeout(function () {
		                        e(document.body).css("height", "100%"), i.page_start(), n._scrollStop(), e(".book-bg").addClass("f-hide"), e(".book-form").addClass("f-hide")
		                    }, 500)
		            ...
		            error: function (t, i, r) {
		                a.showCheckMessage(o, r, !1), setTimeout(function () {
        ...
        return a
    }), define("dist/js/plugins", ["./zepto", "./ylMusic", "./fx", "./weixin", "./Lottery", "./global", "./page", "./media"], function __plugins(t) {
        var e = t("./zepto");
        e = t("./ylMusic"), e = t("./weixin");
        var n = t("./Lottery"),
		i = t("./global"),
		a = t("./page"),
		o = t("./media"),
		r = {
		    init: function () {
		        ...
		        var t = {};
		        "" != e("#r-wx-title").val() && (t.title = e("#r-wx-title").val()), "" != e("#r-wx-img").val() && (t.img = e("#r-wx-img").val()), "" != e("#r-wx-con").val() && (t.con = e("#r-wx-con").val()), "" != e("#r-wx-link").val() && (t.link = e("#r-wx-link").val()), i._weixin && e(document.body).wx(t);
		        var n = e(".translate-front").data("open");
		        if (1 == n) {
		            var a = e("#j-mengban")[0],
						s = "../../template/19/img/page_01_bg@2x.jpg",
						l = e("#r-cover").val(),
						c = "image",
						u = 640,
						h = e(window).height(),
						d = r.start_callback;
		            r.cover_draw(a, s, l, c, u, h, d)
		        } else r.start_callback()
		    },
		    ...
		    start_callback: function () {
		        ...
		        if (i._scrollStart(), a.page_start(), e(document).one("touchstart", function () {
		            o._audio.play()
		        }), 1 == t) {
		            ...
		            o._audioNode.removeClass("f-hide"), o._audio.play()
    ...
    }), define("dist/js/ylMusic", ["./zepto", "./fx"], function (t, e, n) {
        var a = t("./zepto");
        a = t("./fx"), n.exports = a,
	function (t) {
	    t.fn.coffee = function (e) {
	        function n() {
	            var e = r(8, d.steamMaxSize),
					n = o(1, d.steamsFontFamily),
					i = "#" + o(6, "0123456789ABCDEF"),
					a = r(0, 44),
					l = r(-90, 89),
					c = s(.4, 1),
					h = t.fx.cssPrefix + "transform";
	            h = h + ":rotate(" + l + "deg) scale(" + c + ");";
	            var g = t('<span class="coffee-steam">' + o(1, d.steams) + "</span>"),
					m = r(0, f - d.steamWidth - e);
	            m > a && (m = r(0, a)), g.css({
	                position: "absolute",
	                left: a,
	                top: d.steamHeight,
	                ...
	                display: "block",
	                opacity: 1
	            }).attr("style", g.attr("style") + h).appendTo(p).animate({
	                top: r(d.steamHeight / 2, 0),
	                left: m,
	                opacity: 0
	            }, r(d.steamFlyTime / 2, 1.2 * d.steamFlyTime), u, function () {
	                g.remove(), g = null
	            })
	        }
	        ...
	        function a() {
	            var t = r(-10, 10);
	            t += parseInt(p.css("left")), t >= 54 ? t = 54 : 34 >= t && (t = 34), p.animate({
	                left: t
	            }, r(1e3, 3e3), u)
	        }
	        ...
	        function o(t, e) {
	            ...
	            var n = "",
					a = e.length - 1,
					o = 0;
	            for (i = 0; t > i; i++) o = r(0, a - 1), n += e.slice(o, o + 1);
	            return n
	        }
	        ...
	        return t.fn.coffee.stop = function () {
	            ...
	            l = setInterval(function () {
	                n()
	            }, r(d.steamInterval / 2, 2 * d.steamInterval)), c = setInterval(function () {
	                a()
	            }, r(100, 1e3) + r(1e3, 3e3))
	        }, h
    ...
    }), define("dist/js/fx", ["./zepto"], function (t, e, n) {
        var i = t("./zepto");
        n.exports = i,
	function (t, e) {
	    function n(t) {
	    ...
	    t.each(g, function (t, n) {
	    ...
	    }), o = p + "transform", _[r = p + "transition-property"] = _[s = p + "transition-duration"] = _[c = p + "transition-delay"] = _[l = p + "transition-timing-function"] = _[u = p + "animation-name"] = _[h = p + "animation-duration"] = _[f = p + "animation-delay"] = _[d = p + "animation-timing-function"] = "", t.fx = {
	        ...
	        return t.isFunction(i) && (o = i, a = e, i = e), t.isFunction(a) && (o = a, a = e), t.isPlainObject(i) && (a = i.easing, o = i.complete, r = i.delay, i = i.duration), i && (i = ("number" == typeof i ? i : t.fx.speeds[i] || t.fx.speeds._default) / 1e3), r && (r = parseFloat(r) / 1e3), this.anim(n, i, a, o, r)
	    }, t.fn.anim = function (i, a, p, g, m) {
	        var v, y, b, w = {}, C = "",
				k = this,
				S = t.fx.transitionEnd,
				j = !1;
	        if (a === e && (a = t.fx.speeds._default / 1e3), m === e && (m = 0), t.fx.off && (a = 0), "string" == typeof i) w[u] = i, w[h] = a + "s", w[f] = m + "s", w[d] = p || "linear", S = t.fx.animationEnd;
	        else {
	            y = [];
	            for (v in i) x.test(v) ? C += v + "(" + i[v] + ") " : (w[v] = i[v], y.push(n(v)));
	            C && (w[o] = C, y.push(o)), a > 0 && "object" == typeof i && (w[r] = y.join(", "), w[s] = a + "s", w[c] = m + "s", w[l] = p || "linear")
	        }
	        return b = function (n) {
	            if (n !== e) {
	            ...
	            j = !0, t(this).css(_), g && g.call(this)
	        }, a > 0 && (this.bind(S, b), setTimeout(function () {
	            j || b.call(k)
	        }, 1e3 * a + 25)), this.size() && this.get(0).clientLeft, this.css(w), 0 >= a && setTimeout(function () {
	            k.each(function () {
	                b.call(this)
	            })
	        }, 0), this
    ...
    }), define("dist/js/weixin", ["./zepto"], function (t, e, n) {
        var i = t("./zepto");
        n.exports = i,
	function (t) {
	    t.fn.wx = function (e) {
	        function n(t, e) {
	            var i = 2e3;
	            e = e || 0, !0 === window.G_WEIXIN_READY || "WeixinJSBridge" in window ? t.apply(null, []) : i >= e && setTimeout(function () {
	                n(t, e++)
	            }, 15)
	        }
	        var i = t(this),
				a = t.extend({}, t.fn.wx.defaults, e);
	        ...
	        var o = {
	            ...
	            setToolbar: function (t, e) {
	                n(function () {
	                    !0 === t ? WeixinJSBridge.call("showToolbar") : WeixinJSBridge.call("hideToolbar"), o.execAfterMergerHandler(e, [t])
	                })
	            },
	            setOptionMenu: function (t, e) {
	                n(function () {
	                    !0 === t ? WeixinJSBridge.call("showOptionMenu") : WeixinJSBridge.call("hideOptionMenu"), o.execAfterMergerHandler(e, [t])
	                })
	            },
	            pay: function (t, e) {
	                n(function () {
	        ...
	        return handler = {
	            callback: function () { }
	        }, r.Share.timeline(l, handler), r.Share.message(l, handler), r.Share.weibo(s, handler), i
	    }, t.fn.wx.defaults = {
    ...
    }), define("dist/js/Lottery", ["./zepto"], function (t, e, n) {

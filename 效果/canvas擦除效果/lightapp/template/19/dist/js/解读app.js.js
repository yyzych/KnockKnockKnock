//这里依赖的模块都在下面定义了。
define("dist/js/app", ["./zepto", "./touch", "./global", "./page", "./media", "./image", "./event", "./sileFn", "./map", "./ylMap", "./form", "./plugins", "./ylMusic", "./fx", "./weixin", "./Lottery"],
        ...
        init_modle: function() {
            ...
            function() {
                ...
                setTimeout(function() {
                    ...
                    4e3);
                    var mengban = $(".translate-front").data("open");//在元素上存放数据,然后取回该数据。
...
function(t, e, n) {
    var i = function() {
        ...
        V.fragment = function(t, e, n) {
            ...
            i || (t.replace && (t = t.replace(q, "<$1></$2>")), e === b && (e = A.test(t) && RegExp.$1), e in H || (e = "*"), r = H[e], r.innerHTML = "" + t, i = C.each(E.call(r.childNodes),
            function() {
                r.removeChild(this)
            })),
            o(n) && (a = C(i), C.each(n,
        ...
        C.fn = {
            ...
            toggle: function(t) {
                return this.each(function() {
                    var e = C(this); (t === b ? "none" == e.css("display") : t) ? e.show() : e.hide()
                })
            },
            prev: function(t) {
            ...
            attr: function(t, e) {
                ...
                return "string" == typeof t && e === b ? 0 == this.length || 1 !== this[0].nodeType ? b: "value" == t && "INPUT" == this[0].nodeName ? this.val() : !(n = this[0].getAttribute(t)) && t in this[0] ? this[0][t] : n: this.each(function(n) {
                    if (1 === this.nodeType) if (a(t)) for (w in t) v(this, w, t[w]);
            ...
            prop: function(t, e) {
                return t = X[t] || t,
                e === b ? this[0] && this[0][t] : this.each(function(n) {
            ...
            css: function(e, n) {
                ...
                else for (w in e) e[w] || 0 === e[w] ? r += c(w) + ":" + h(w, e[w]) + ";": this.each(function() {
            ...
            toggleClass: function(t, e) {
                return t ? this.each(function(n) {
                    var i = C(this),
                    a = m(this, t, n, x(this));
                    a.split(/\s+/g).forEach(function(t) { (e === b ? !i.hasClass(t) : e) ? i.addClass(t) : i.removeClass(t)
                    })
                }) : this
            },
    ...
    function(t) {
        ...
        function u(t) {
            ...
            t && (t == C ? "html": t == w ? "json": y.test(t) ? "script": b.test(t) && "xml") || "text"
        }
        ...
        t.ajax = function(e) {
            ...
            d(n),
            n.cache === !1 && (n.url = h(n.url, "_=" + Date.now()));
            var l = n.dataType,
            f = /\?.+=\?/.test(n.url);
            if ("jsonp" == l || f) return f || (n.url = h(n.url, n.jsonp ? n.jsonp + "=?": n.jsonp === !1 ? "": "callback=?")),
            t.ajaxJSONP(n, a);
            var p, v = n.accepts[l],
            x = {},
            _ = function(t, e) {
            ...
            if (a && a.promise(b), n.crossDomain || _("X-Requested-With", "XMLHttpRequest"), _("Accept", v || "*/*"), (v = n.mimeType || v) && (v.indexOf(",") > -1 && (v = v.split(",", 2)[0]), b.overrideMimeType && b.overrideMimeType(v)), (n.contentType || n.contentType !== !1 && n.data && "GET" != n.type.toUpperCase()) && _("Content-Type", n.contentType || "application/x-www-form-urlencoded"), n.headers) for (m in n.headers) _(m, n.headers[m]);
            if (b.setRequestHeader = _, b.onreadystatechange = function() {
                if (4 == b.readyState) {
                    ...
                    if (b.status >= 200 && 300 > b.status || 304 == b.status || 0 == b.status && "file:" == y) {
                        l = l || u(n.mimeType || b.getResponseHeader("content-type")),
                        e = b.responseText;
                        try {
            ...
            o(b, n) === !1) return b.abort(),
            s(null, "abort", b, n, a),
            b;
            if (n.xhrFields) for (m in n.xhrFields) b[m] = n.xhrFields[m];
        ...
        t.fn.load = function(e, n, i) {
            ...
            s.success = function(e) {
                o.html(a ? t("<div>").html(e.replace(_, "")).find(a) : e),
...
function(t, e, n) {
    ...
    function(t) {
        ...
        t(document).ready(function() {
            ...
            function(e) { (!(v = r(e, "down")) || o(e)) && (m = v ? e: e.touches[0], e.touches && 1 === e.touches.length && d.x2 && (d.x2 = void 0, d.y2 = void 0), p = Date.now(), g = p - (d.last || p), d.el = t("tagName" in m.target ? m.target: m.target.parentNode), s && clearTimeout(s), d.x1 = m.pageX, d.y1 = m.pageY, g > 0 && 250 >= g && (d.isDoubleTap = !0), d.last = p, u = setTimeout(n, f), h && v && h.addPointer(e.pointerId))
            }).on("touchmove MSPointerMove pointermove",
            function(t) { (!(v = r(t, "move")) || o(t)) && (m = v ? t: t.touches[0], i(), d.x2 = m.pageX, d.y2 = m.pageY, x += Math.abs(d.x1 - d.x2), _ += Math.abs(d.y1 - d.y2))
            }).on("touchend MSPointerUp pointerup",
            function(n) { (!(v = r(n, "up")) || o(n)) && (i(), d.x2 && Math.abs(d.x1 - d.x2) > 30 || d.y2 && Math.abs(d.y1 - d.y2) > 30 ? c = setTimeout(function() {
                    d.el.trigger("swipe"),
                ...
                0) : "last" in d && (30 > x && 30 > _ ? l = setTimeout(function() {
                    ...
                    e.cancelTouch = a,
                    d.el.trigger(e),
                    d.isDoubleTap ? (d.el && d.el.trigger("doubleTap"), d = {}) : s = setTimeout(function() {
                        s = null,
...
function __global(t) {
    ...
    i = {
        ...
        _scrollStop: function() {
            ...
            e(window).on("touchmove.scroll", this._scrollControl),
            e(window).on("scroll.scroll", this._scrollControl)
        },
        _scrollStart: function() {
            e("body").removeClass("f-ofh"),
            e(window).off("touchmove.scroll"),
            e(window).off("scroll.scroll")
        },
...
function __page(t) {
    ...
    i = {
        ...
        height_auto: function(t, i) {
            ...
            o = !0;
            if (o) t.children(".page-con").height(a + 2),
            e(".p-ct").hasClass("fixed") || "true" != i || e(".p-ct").addClass("fixed");
            else {
                if (! (a >= t.height())) return n._scrollStart(),
                "true" == i && e(".p-ct").removeClass("fixed"),
                t.children(".page-con").css("height", "100%"),
                void 0;
                t.children(".page-con").height(a + 2),
                e(".p-ct").hasClass("fixed") || "true" != i || e(".p-ct").addClass("fixed")
            }
        }
    };
...
function __media(t) {
    ...
    i = {
        ...
        audio_play: function() {
            i._audio_val = !1,
            i._audio && i._audio.play()
        },
        audio_stop: function() {
            i._audio_val = !0,
            i._audio && i._audio.pause()
        },
        video_init: function() {
            this._videoNode.each(function() {
                ...
                i = e(this).find(".img");
                for (var a in t) t.hasOwnProperty(a) && a in n && (n[a] = t[a]),
                this.appendChild(n);
                e(n).on("play",
                function() {
                    i.hide(),
                    e(n).removeClass("f-hide")
                }),
                e(n).on("pause",
                function() {
                    i.show(),
        ...
        media_control: function() {
            this._audio && (0 >= e("video").length || (e(this._audio).on("play",
            function() {
    ...
    function(t) {
        t.fn.ylmap = function(e) {
            ...
            return this.each(function() {
                ...
                var _ = function() {
                    l.size() > 0 && (o = new BMap.Map(x.attr("id")), r = new BMap.Point(h, u), s = new BMap.Marker(r), o.enableScrollWheelZoom(), o.enableInertialDragging(), o.centerAndZoom(r, 15), o.addOverlay(s), y(), s.addEventListener("click",
                    function() {
                        y()
...
define("dist/js/plugins", ["./zepto", "./ylMusic", "./fx", "./weixin", "./Lottery", "./global", "./page", "./media"],
function __plugins(t) {
    ...
    r = {
        init: function() {
            ...
            if (1 == n) {
                var a = e("#j-mengban")[0],//canvas的父级
                s = "../../template/19/img/page_01_bg@2x.jpg",
                l = e("#r-cover").val(),//图片的原地址值
                c = "image",
                u = 640,
                h = e(window).height(),
                d = r.start_callback;
        ...
        cover_draw: function(t, e, i, a, o, r, s) {
            if (! (t.style.display.indexOf("none") > -1)) {
                var l = new n(t, i, a, o, r, s);//这里开始画图---------------------
                l.init()
            }
        },
        start_callback: function() {//回调函数
            var t = e(".translate-front").data("open");
            if (i._scrollStart(), a.page_start(), e(document).one("touchstart",
            function() {
                o._audio.play()
            }), 1 == t) {
    ...
    function(t) {
        t.fn.coffee = function(e) {
            function n() {
                ...
                r(d.steamFlyTime / 2, 1.2 * d.steamFlyTime), u,
                function() {
                    g.remove(),
                    g = null
                })
            ...
            t.fn.coffee.start = function() {
                ...
                r(d.steamInterval / 2, 2 * d.steamInterval)),
...
function(t, e, n) {
    ...
    function(t, e) {
        ...
        o = p + "transform",
        _[r = p + "transition-property"] = _[s = p + "transition-duration"] = _[c = p + "transition-delay"] = _[l = p + "transition-timing-function"] = _[u = p + "animation-name"] = _[h = p + "animation-duration"] = _[f = p + "animation-delay"] = _[d = p + "animation-timing-function"] = "",
        t.fx = {
        ...
        t.fn.anim = function(i, a, p, g, m) {
            ...
            j = !1;
            if (a === e && (a = t.fx.speeds._default / 1e3), m === e && (m = 0), t.fx.off && (a = 0), "string" == typeof i) w[u] = i,
            w[h] = a + "s",
            w[f] = m + "s",
            w[d] = p || "linear",
            S = t.fx.animationEnd;
                ...
                C && (w[o] = C, y.push(o)),
                a > 0 && "object" == typeof i && (w[r] = y.join(", "), w[s] = a + "s", w[c] = m + "s", w[l] = p || "linear")
            }
            return b = function(n) {
                if (n !== e) {
